...
- No ownership transfer or permanent room deletion UI in this release. Operators can immediately delist and soft-delete rooms from the CLI.
...
Future adapters: PostgreSQL repository, event bus, additional `MediaProvider` implementations, chat storage, recovery credentials, invitation UX, and a web moderation dashboard.
